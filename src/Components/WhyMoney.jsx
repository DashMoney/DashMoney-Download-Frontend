    ...
    return (
      <>
        <div id="easyReadText">
          ...
          <p>
            When water/money(fiat) can be created at a below market price then
            it throws the entire system off. And even if the person in charge
            were to just give it all away. It would still throw the entire
            system into chaos. It breaks the chain of causality, it separates
            causes and effects.
          </p>
          <p>
            Because there would be no notion of what causes that
            water/money(fiat) to have the value that it currently possesses, and
            so how could anyone with the newly created water/money know the best
            way to use it. And furthermore, how could they foresee the
            consequences of what would happen, even if they used it for only
            “good”.
          </p>
          <p style={{ fontStyle: "italic" }}>
            As an aside - Please understand that the market should not be
            confused with a large group of people. Money(not fiat) is able to
            create the network of users(quantum computers) , because it
            functions through the money(specie)-price mechanism. A group of
            people have no such advantage, and it is dangerous to think they
            might.
          </p>
          <p>
          ...
          <div className="bodytext">
            ...
            <p>
              All “improvements” result in failure and always will, because
              money is the most powerful computation force in the universe. And
              any “improvement” only destroys the computation mechanism that
              emerges from a true P2P sound money.{" "}
            </p>

            <p>
              P2P sound money results in the network effect of millions or
              billions of the most powerful and efficient quantum computers in
              the universe. Only man in his ignorance could think he could do
              better. Improvements upon money are nothing more than the folly of
              man’s pride.
            </p>
            ...
            <p>
              Evolution is not an end, its a process. And where does it go?
              There has always been only one destination, Money.
            </p>
            ...
            <p>
              We have to go WAY back. Back to single cell organisms that work
              together and are beneficial to one another and cooperate in a
              voluntary way. So we have to operate in a P2P way. One person to
              another person, and that is only where it starts.
            </p>

            <p>For this is certain, </p>
            <p style={{ marginLeft: "2rem" }}>
              <b>
                “Money is a simple idea. It can be known and understood by even
                the most humble of minds.”{" "}
              </b>
            </p>
            <p>
              And maybe that is why no one in crypto has been able to get it
              right.
            </p>

            <p style={{ marginTop: "1rem" }} className="textsmaller">
              ..for hiding these things from the learned and the clever and
              revealing them to little children. Yes, Father, for that is what
          ...
          <div style={{ paddingLeft: "1rem", paddingRight: "1rem" }}>
            ...
            <div style={{ paddingLeft: "1rem", paddingRight: "1rem" }}>
              ...
              <p style={{ marginLeft: "1rem" }}>
                Also what I mean by “less than market price” is this: What does
                it cost to get money or receive money from others? Well it
                depends on what good or service, you are selling. That is the
                market price of money. The price of any good or service that is
                exchanged in the market is the market price of money.
              </p>
            </div>
            <p>
              Any deviation from money(not fiat) as described above creates
              market distortions and hinders the ability of money to perform the
